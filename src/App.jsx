...
function App() {
  ...
  const repos = [
    ...
    {
      name: 'tiempoAPI',
      description: 'Weather application with city search, live API data, and a clean responsive forecast interface.',
      stack: ['API', 'JavaScript', 'Weather'],
      focus: 'Weather app',
      icon: 'https://res.cloudinary.com/djuisin8z/image/upload/v1776873339/Captura_elyi2d.png',
      link: 'https://github.com/GerardoCL31/tiempoAPI',
      demoLink: 'https://tiempo.gerardocorona.io/?city=Madrid',
    },
    {
      name: 'SorteoIG',
      description: 'Instagram giveaway app with a clean flow, deployed demo, and frontend-focused interaction.',
      stack: ['React', 'Frontend', 'Deploy'],
      focus: 'Giveaway app',
      icon: 'https://res.cloudinary.com/djuisin8z/image/upload/v1777360323/sorteo_f8f8vt.png',
      link: 'https://github.com/GerardoCL31/SorteoIG',
      demoLink: 'https://sorteoig.gerardocorona.io/',
    },
    {
      name: 'FOXHOUND',
